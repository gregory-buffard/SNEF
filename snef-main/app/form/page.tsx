...
const WeekCol = () => {
  ...
  return (
    <main className="w-1/2 iP:w-11/12 h-screen m-auto flex flex-col justify-center items-center not-italic space-y-[3vh] select-none">
      {loading ? (
        ...
        <>
          ...
          <Link
            href={"https://www.snef.cloud"}
            className={
              "absolute left-[6vw] iP:left-[26vw] -top-[1vh] bg-neutral-100 px-[0.25vw] py-[0.25vw] rounded-[0.25vw] hover:bg-neutral-300 shadow-inner iP:text-[3vh] iP:px-[1.5vw] iP:py-[1.5vw] iP:rounded-[2vw]"
            }
          >
            <IoIosArrowBack />
          </Link>
          ...
          >
            <button
              type={"button"}
              onClick={() => setAddWorkspaceDialog(!addWorkspaceDialog)}
              className={
            ...
            <div>
              ...
              <input
                ...
                className={
                  "iP:text-neutral-800 border-[.1vw] iP:border-[.25vh] border-neutral-300 outline-none rounded-[.25vw] iP:rounded-[1vh] px-[.25vw] iP:px-[.5vh] py-[.25vh] bg-neutral-50 hover:bg-neutral-300 focus:bg-neutral-300 transition-colors duration-200 ease-in-out drop-shadow-xl"
                }
              />
            </div>
            ...
            <button
              ...
              className={
                "iP:text-neutral-800 flex justify-start items-center space-x-[.25vw] iP:space-x-[.5vh] bg-neutral-300 px-[.5vw] iP:px-[1vh] py-[.5vh] rounded-[.25vw] iP:rounded-[1vh] shadow-inner hover:bg-neutral-400 transition-colors duration-200 ease-in-out"
              }
            >
              <IoMdAddCircle />
              <p>Ajouter</p>
